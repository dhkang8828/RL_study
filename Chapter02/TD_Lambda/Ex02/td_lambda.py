...
def td_lambda(env, policy, lam, color):
    ...
    for loop_count in range(1500):
        ...
        ## Calculate TD_lambda and update value function
...
if __name__ == "__main__":
    ...
    print(f"λ:{0.3}, value_vector:\n{value_vector_1}")
    print(f"λ:{0.6}, value_vector:\n{value_vector_2}")
    print(f"λ:{0.9}, value_vector:\n{value_vector_3}")
    
    plt.legend()
    plt.savefig("./develop/RL_study/TD_Lambda/Ex02_td_lambda.jpg")
