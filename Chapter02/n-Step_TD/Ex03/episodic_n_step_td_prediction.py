...
def episodic_n_step_td_value_predictioln(env, policy, n, color):
...
if __name__ == "__main__":
    ...
    value_vector_1 = episodic_n_step_td_value_predictioln(env, policy, n=1, color='red')
    value_vector_3 = episodic_n_step_td_value_predictioln(env, policy, n=3, color='green')
    value_vector_5 = episodic_n_step_td_value_predictioln(env, policy, n=5, color='blue')
    
    print(f"n:{1}, vlue_vector: \n{value_vector_1}")
    print(f"n:{3}, vlue_vector: \n{value_vector_3}")
    print(f"n:{5}, vlue_vector: \n{value_vector_5}")
    
    plt.legend()
    plt.savefig("EX03_episodic_n_step_td_prediction.jpg")
