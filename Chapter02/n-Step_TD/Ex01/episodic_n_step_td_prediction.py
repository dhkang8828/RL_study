...
def episodic_n_step_td_value_prediction(env, policy, n, color):
    ...
    for loop_count in range(2000):
        ...
        episode['states'].append(s) ## append s_T (terminal state)
    ...
    ##plt.title("episodic_n-step TD prediction")
...
if __name__ == "__main__":
    ...
    value_vector_1 = episodic_n_step_td_value_prediction(env, policy, n=1, color='red')
    value_vector_3 = episodic_n_step_td_value_prediction(env, policy, n=3, color='green')
    value_vector_5 = episodic_n_step_td_value_prediction(env, policy, n=5, color='blue')
